// Cloudflare Worker entry for Driving Empire Wiki
...
// IndexNow key: project-specific key for drivingempirewiki.wiki
const INDEXNOW_KEY = '49af15980a8ff952c414b4de0390ef0e';
const HOST = 'www.drivingempirewiki.wiki';
...
async function handleIndexNow(request) {
  ...
  if (request.method === 'GET') {
    ...
    const locales = ['en', 'pt', 'de', 'ja'];
    const categories = [
      'guides', 'codes', 'tier-list', 'vehicles',
      'tuning', 'updates', 'racing-modes', 'developer',
    ];
    const allUrls = [];
